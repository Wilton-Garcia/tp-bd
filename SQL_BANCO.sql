...
-- -----------------------------------------------------
-- Schema tp_banco_de_dados
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema tp_banco_de_dados
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `tp_banco_de_dados` DEFAULT CHARACTER SET utf8 ;
USE `tp_banco_de_dados` ;

-- -----------------------------------------------------
-- Table `tp_banco_de_dados`.`TB_ENDERECO`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tp_banco_de_dados`.`TB_ENDERECO` (
...
-- -----------------------------------------------------
-- Table `tp_banco_de_dados`.`TB_AEROPORTO`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tp_banco_de_dados`.`TB_AEROPORTO` (
  ...
  CONSTRAINT `fk_TB_AEROPORTO_TB_ENDERECO1`
    ...
    REFERENCES `tp_banco_de_dados`.`TB_ENDERECO` (`ID_ENDERECO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `tp_banco_de_dados`.`TB_COMPANHIA_AEREA`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tp_banco_de_dados`.`TB_COMPANHIA_AEREA` (
...
-- -----------------------------------------------------
-- Table `tp_banco_de_dados`.`TB_OPERACAO_AEROPORTO_CIA_AEREA`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tp_banco_de_dados`.`TB_OPERACAO_AEROPORTO_CIA_AEREA` (
  `ID_AEROPORTO` INT NOT NULL,
  `ID_COMPANHIA_AEREA` INT NOT NULL,
  ...
  CONSTRAINT `fk_TB_AEROPORTO_has_TB_COMPANHIA_AEREA_TB_AEROPORTO`
    ...
    REFERENCES `tp_banco_de_dados`.`TB_AEROPORTO` (`ID_AEROPORTO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_TB_AEROPORTO_has_TB_COMPANHIA_AEREA_TB_COMPANHIA_AEREA1`
    FOREIGN KEY (`ID_COMPANHIA_AEREA`)
    REFERENCES `tp_banco_de_dados`.`TB_COMPANHIA_AEREA` (`ID_COMPANHIA_AEREA`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `tp_banco_de_dados`.`TB_CARGO`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tp_banco_de_dados`.`TB_CARGO` (
...
-- -----------------------------------------------------
-- Table `tp_banco_de_dados`.`TB_FUNCIONARIO`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tp_banco_de_dados`.`TB_FUNCIONARIO` (
  ...
  CONSTRAINT `fk_TB_FUNCIONARIO_TB_CARGO1`
    ...
    REFERENCES `tp_banco_de_dados`.`TB_CARGO` (`ID_CARGO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `tp_banco_de_dados`.`TB_AERONAVE`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tp_banco_de_dados`.`TB_AERONAVE` (
...
-- -----------------------------------------------------
-- Table `tp_banco_de_dados`.`TB_VOO`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tp_banco_de_dados`.`TB_VOO` (
  `ID_VOO` INT NOT NULL,
  `NR_VOO` INT NULL,
...
-- -----------------------------------------------------
-- Table `tp_banco_de_dados`.`TB_OCORRENCIA_VOO`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tp_banco_de_dados`.`TB_OCORRENCIA_VOO` (
  ...
  CONSTRAINT `fk_TB_VOO_has_TB_AERONAVE_TB_VOO1`
    FOREIGN KEY (`ID_VOO`)
    REFERENCES `tp_banco_de_dados`.`TB_VOO` (`ID_VOO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_TB_VOO_has_TB_AERONAVE_TB_AERONAVE1`
    FOREIGN KEY (`ID_AERENAVE`)
    REFERENCES `tp_banco_de_dados`.`TB_AERONAVE` (`ID_AERENAVE`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `tp_banco_de_dados`.`TB_ESCALA_FUNCIONARIOS_OCV`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tp_banco_de_dados`.`TB_ESCALA_FUNCIONARIOS_OCV` (
  `ID_OCORRENCIA_VOO` INT NOT NULL,
  `ID_FUNCIONARIO` INT NOT NULL,
  ...
  CONSTRAINT `fk_TB_OCORRENCIA_VOO_has_TB_FUNCIONARIO_TB_OCORRENCIA_VOO1`
    ...
    REFERENCES `tp_banco_de_dados`.`TB_OCORRENCIA_VOO` (`ID_OCORRENCIA_VOO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_TB_OCORRENCIA_VOO_has_TB_FUNCIONARIO_TB_FUNCIONARIO1`
    FOREIGN KEY (`ID_FUNCIONARIO`)
    REFERENCES `tp_banco_de_dados`.`TB_FUNCIONARIO` (`ID_FUNCIONARIO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `tp_banco_de_dados`.`TB_EMPRESA_ALIMENTACAO`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tp_banco_de_dados`.`TB_EMPRESA_ALIMENTACAO` (
...
-- -----------------------------------------------------
-- Table `tp_banco_de_dados`.`TB_SERVICO_PRESTADO`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tp_banco_de_dados`.`TB_SERVICO_PRESTADO` (
  `ID_COMPANHIA_AEREA` INT NOT NULL,
  `ID_EMPRESA_ALIMENTACAO` INT NOT NULL,
  ...
  CONSTRAINT `fk_TB_COMPANHIA_AEREA_has_TB_EMPRESA_ALIMENTACAO_TB_EMPRESA_A1`
    ...
    REFERENCES `tp_banco_de_dados`.`TB_EMPRESA_ALIMENTACAO` (`ID_EMPRESA_ALIMENTACAO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
